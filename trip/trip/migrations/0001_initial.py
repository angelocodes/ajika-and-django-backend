    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('sightseeing', 'Sightseeing'), ('hiking', 'Hiking'), ('beach', 'Beach'), ('cultural', 'Cultural'), ('adventure', 'Adventure'), ('relaxation', 'Relaxation'), ('other', 'Other')], max_length=100)),
